...
export const SAMPLE_COURSES: Course[] = [
  // ── Lower Division ──────────────────────────────────────────────────────────
  {
    ...
    description: "Introduction to programming fundamentals using Python. Topics include variables, control structures, functions, and basic object-oriented programming.",
    prerequisites: [],
    departments: ["CSE"],
    genEd: ["Major"],
    termsOffered: ["Fall"],           // Fall only — strictly limited quarter
    tags: ["Major"],
  },
  {
    id: "cse12",
  ...
  },
  {
    ...
    units: 4,
    category: "Lower Division",
    description: "Mathematical reasoning: propositional logic, sets, relations, functions, induction, combinatorics, and graph theory.",
    prerequisites: [],
  ...
  // ── General Education ────────────────────────────────────────────────────────
  {
    ...
    departments: ["MATH"],
    genEd: ["GE", "Major"],
    termsOffered: ["Fall", "Winter"],  // not offered Spring
    tags: ["GE", "Major"],
  },
  {
    id: "math20b",
  ...
  // ── Upper Division ───────────────────────────────────────────────────────────
  {
    ...
    description: "Advanced data structures: balanced trees, heaps, hash tables, and graph algorithms with complexity analysis.",
